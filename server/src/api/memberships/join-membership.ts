...
import { CreateMembershipRequest, CreateMembershipResponse } from '@clubhive/shared';
...
export const joinMembershipEndpoint: ApiEndpoint<CreateMembershipRequest, CreateMembershipResponse> = {
