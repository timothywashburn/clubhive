...
async function seed() {
    ...
    //note: there might be an easier way to get club's id?
    ...
    await Event.insertMany([
        ...
        {
            club: wcent._id,
            name: 'Introductory Workshop event',
            description: 'Come learn the basics of tool use!',
            type: EventType.UCSD_STUDENTS,
            location: 'Geisel Library',
        ...
        },
        {
            club: tg._id,
            name: 'First Fall GBM',
            description: 'Game Night + come meet the board members!',
