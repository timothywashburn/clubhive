            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
                    {filteredEvents.map(event => (
                        <div
                            key={event._id}
                            className="bg-surface rounded-lg shadow border border-outline-variant overflow-hidden flex flex-col"
                        >
                            {/* Event thumbnail */}
                            <img src={event.flyerUrl || '/placeholder-event.jpg'} alt={event.name} className="w-full h-48 object-cover" />
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                ...
                                {/* Tags */}
                                <div className="text-sm text-on-surface-variant flex flex-wrap gap-2 mb-4">
                                    {event.tags
                                ...
                                {/* Date, time, location */}
                                <div className="mt-auto flex items-center text-sm text-on-surface-variant space-x-4">
