            ...
            <div className="flex-1">
                <div className="bg-surface rounded-lg shadow p-6 border border-outline-variant h-[586px]">
                    <div className="flex items-center mb-6">
                        ...
                        <h3 className="text-xl font-semibold text-on-surface ml-4">
                            {monthYear}
                        </h3>
                    </div>
                    ...
                    <div className="grid grid-cols-7 gap-1 mb-2">
                        {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(
                            day => (
                                <div
                                    key={day}
                                    className="p-2 text-center text-sm font-medium text-on-surface-variant"
                                >
                                    {day}
                                </div>
                            )
                    ...
                    <div className="grid grid-cols-7 gap-0 border border-outline-variant/30 rounded-lg overflow-hidden">
                        {calendarDays.map((day, index) => {
                            ...
                            if (isFirstRow && isFirstCol)
                                roundingClasses = 'rounded-tl-lg';
                            else if (isFirstRow && isLastCol)
                                roundingClasses = 'rounded-tr-lg';
                            else if (isLastRow && isFirstCol)
                                roundingClasses = 'rounded-bl-lg';
                            else if (isLastRow && isLastCol)
                                roundingClasses = 'rounded-br-lg';
