    ...
    return (
        <div className="bg-surface rounded-lg shadow border border-outline-variant h-fit">
            <div className="p-4 border-b border-outline-variant">
                <h2 className="text-lg font-semibold text-on-surface">My Clubs</h2>
            </div>
            <div className="p-2">
                {clubs.length === 0 && (
                    <button
                ...
                {clubs.map(club => {
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center space-x-3">
                                <div
                                    className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold ${getClubColors(club._id)}`}
                                >
                                    {clubInitials}
                                </div>
                                <div className="flex-1 min-w-0">
                                ...
                                {club.userRole === 'owner' && <Crown className="w-4 h-4 text-yellow-500 flex-shrink-0" />}
